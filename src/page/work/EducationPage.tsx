...
import { educationData, work } from '../../data/Education';
    ...
    <div className="min-h-screen relative p-6 md:p-12 transition-colors duration-300">
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2 rounded-full flex items-center gap-2 mb-8 shadow-lg hover:shadow-xl transition-all duration-300"
        >
        ...
        <div className="relative">
          {work.map((work, index) => (
            ...
            >
              ...
              <div className="absolute md:relative left-0 flex items-center md:justify-end">
                <div className="hidden md:flex items-center text-gray-500 mr-8 mb-8 text-blue-800 dark:text-blue-200">
                  <Calendar className="mr-2" /> <span>{work.time}</span>
                </div>
              </div>
              ...
              <div className="pb-12">
                <div className="relative pl-8 md:pl-0">
                  ...
                  {/* Work Details */}
                  <div>
                    <h2 className="text-2xl font-bold mb-2  whitespace-pre-line">{work.title}</h2>
                    <p
                      className="text-gray-600 leading-relaxed dark:text-blue-200 text-justify"
